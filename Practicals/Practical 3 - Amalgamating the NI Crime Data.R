#Task 1:
csv_file_list <- list.files(path = "C:/Users/Goutham Siddhaarth/Source/Repos/DataScience/Practicals/Data/NI Crime Data/", pattern = "*.csv")
combine_results <- function(file_list) {
    data_frame <- NULL
    for (file in file_list) {
        data <- read.csv(header = TRUE, paste("C:/Users/Goutham Siddhaarth/Source/Repos/DataScience/Practicals/Data/NI Crime Data/", file, sep = ""), stringsAsFactors = FALSE)
...
str(AllNICrimeData)
NROW(AllNICrimeData)
write.csv(AllNICrimeData, file = "C:/Users/Goutham Siddhaarth/Source/Repos/DataScience/Practicals/Data/AllNICrimeData.csv", row.names = FALSE)
...
postcode_data <- read.csv("C:/Users/Goutham Siddhaarth/Source/Repos/DataScience/Practicals/Data/CLeanNIPostcodeData.csv", stringsAsFactors = FALSE)
#Removing duplicates
...
#Task9
write.csv(AllNICrimeData, file = "C:/Users/Goutham Siddhaarth/Source/Repos/DataScience/Practicals/Data/FinalNICrimeData.csv ", row.names = FALSE)
