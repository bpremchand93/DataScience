...
postcode_data <- read.csv("C:/LYIT/Data Science/Practicals/Data/NIPostcodes.csv", header = FALSE, stringsAsFactors = FALSE, na.strings = c("", "NA"))
...
head(postcode_data, 10)
str(postcode_data)
write.table(postcode_data, file = "Cleaned Data.txt")
class(postcode_data)
...
str(Limavady_data)
head(Limavady_data)
write.csv(Limavady_data, file = "C:/LYIT/Data Science/Practicals/Data/Limavady.csv", row.names = FALSE)

#Step 9: Save the modified dataset in a csv file called CleanNIPostcodeData.
write.csv(postcode_data, file = "C:/LYIT/Data Science/Practicals/Data/CLeanNIPostcodeData.csv", row.names = FALSE)
